...
export default function V1CleanModern() {
  const {
    metadata,
    pipelines,
    selectedPipelineId,
  ...
  if (loading && !draft) {
    return (
      <div className="v1-app" style={{ display: "flex", alignItems: "center", justifyContent: "center" }}>
        Loading admin UI…
      </div>
    );
  }
    ...
    <div className="v1-app">
      <aside className="v1-sidebar">
        <div className="v1-sidebar-header">
          ...
          <p>Industrial minimal editor</p>
        </div>
        <button className="v1-btn" type="button" onClick={duplicateDraft}>
          Duplicate Into Draft
        </button>
        <div className="v1-pipeline-list">
          {pipelines.map((pipeline) => (
            <button
              key={pipeline.id}
              type="button"
              className={`v1-pipeline-item ${selectedPipelineId === pipeline.id ? "v1-selected" : ""}`}
              onClick={() => void selectPipeline(pipeline.id)}
            >
              <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", gap: 8 }}>
                <strong>{pipeline.name}</strong>
                <span className={`v1-status ${pipeline.enabled ? "v1-on" : "v1-off"}`}>
                  {pipeline.enabled ? "Enabled" : "Disabled"}
                </span>
              </div>
              <p>{pipeline.description}</p>
              <div className="v1-pipeline-meta">
        ...
        {draft ? (
          <>
            <section className="v1-panel">
              <div className="v1-editor-header">
                <div>
                  <div className="v1-eyebrow">Editor</div>
                  <h2>{draft.name}</h2>
                </div>
                <span className={`v1-status ${draft.enabled ? "v1-on" : "v1-off"}`}>
              ...
              <div className="v1-grid">
                <section className="v1-section">
                  <h3 className="v1-section-title">Basics</h3>
                  <label>
                    <span>Name</span>
                ...
                <section className="v1-section">
                  <h3 className="v1-section-title">Trigger</h3>
                  <label>
                ...
                <section className="v1-section">
                  <h3 className="v1-section-title">Execution</h3>
                  <label>
                    <span>Preset</span>
                ...
                <section className="v1-section">
                  <h3 className="v1-section-title">Workspace + Preparation</h3>
                  <label>
                ...
                <section className="v1-section">
                  <h3 className="v1-section-title">Filters + Output</h3>
                  <label>
            ...
            <section className="v1-panel">
              <div className="v1-preview-header">
                <div>
                  <div className="v1-eyebrow">Preview</div>
              ...
              <div className="v1-stats">
                <div className="v1-stat">
                  <span className="v1-stat-label">Trigger</span>
              ...
              <div className="v1-feedback">
                <div className="v1-feedback-block">
                  <h3>Validation</h3>
                  <ul>
